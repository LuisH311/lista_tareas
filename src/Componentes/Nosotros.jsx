...
function Nosotros() {
  return (
    <div>
      ...
      <article>
      <h3>¿Qué es mi producto y para que sirve? </h3>
      <p>Un aplicativo de gestión de tarea con una estructura sencilla, se ha diseñado para el facil manejo y para ser mas organizado con sus deberes diarios.</p>
